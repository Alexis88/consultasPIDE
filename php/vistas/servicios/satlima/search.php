...
ClassHub::stopServiceLoad('satlima');
...
<body>
	<header id="cabecera">
		<h2>SAT DE LIMA - BUSCAR PREDIOS</h2>			
	</header>

	<form id="data" method="post">
		<section>
			<input type="search" name="dni" placeholder=" " required data-rest autocomplete="off" required minlength="8" maxlength="8" class="number" />
