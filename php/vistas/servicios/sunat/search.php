...
ClassHub::stopServiceLoad('sunat');
...
<body>
	<header id="cabecera">
		<h2>SUNAT - BUSCAR DATOS</h2>			
	</header>

	<form id="data" method="post">
		<section>
			<input type="search" name="ruc" placeholder=" " data-rest autocomplete="off" autofocus required minlength="3" maxlength="80" class="string pide" />
			<label>N° de RUC o razón social</label>
		</section>							
		<section>	
